        ...
        private void KvnUpdateCoreInfo()
        {
            ...
            switch (coreType)
            {
                case VpnCoreType.SingBox:
                    ...
                    txtKvnHint.Text = "sing-box найден. Для TUN-режима запускайте лаунчер от имени администратора.";
                ...
                case VpnCoreType.Xray:
                    ...
                    txtKvnHint.Text = "xray найден. Будет использоваться системный прокси (браузеры и большинство приложений).";
